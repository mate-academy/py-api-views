...
from cinema.views import (
    ...
    GenreList, GenreDetailView,
    ActorList, ActorDetailView,
...
urlpatterns = [
    ...
    path("cinema_hall/", cinema_hall_list, name="actor-list"),
    path("cinema_hall/<int:pk>/", cinema_hall_detail, name="actor-detail"),
